...
public class HistoryDetailAdapter extends RecyclerView.Adapter<HistoryDetailAdapter.ViewHolder> {
    ...
    public HistoryDetailAdapter(Context context, ArrayList<NoteHistory> list, int type, HistoryAdapter.Callback callback) {
    ...
    public void setListHistory(ArrayList<NoteHistory> data) {
        list = data;
